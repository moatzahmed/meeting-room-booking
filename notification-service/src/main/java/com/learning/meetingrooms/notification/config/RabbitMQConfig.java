package com.learning.meetingrooms.notification.config;
...
public class RabbitMQConfig {
    ...
    Binding createdBinding(Queue notificationQueue, TopicExchange bookingExchange) {
        return BindingBuilder.bind(notificationQueue).to(bookingExchange).with("booking.created");
    }

    @Bean
    Binding cancelledBinding(Queue notificationQueue, TopicExchange bookingExchange) {
        return BindingBuilder.bind(notificationQueue).to(bookingExchange).with("booking.cancelled");
    }
